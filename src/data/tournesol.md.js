import img01 from "assets/img/tournesol/01/large.png";

export default `
  <ResponsiveImg src="${img01}" alt="Professeur Tournesol" title="Professeur Tournesol" />

  <Waypoint><p>Ce n'est ni un nom ni un prénom, c'est beaucoup plus ; Tintin c'est un univers, un mythe, une saga. C'est le héros que tous les jeunes de 7 à 77 ans veulent être ou sont lorsqu'ils plongent dans les aventures de Tintin.</p></Waypoint>
  ...
  <Waypoint><p>D'abord Milou, il est certes un animal mais, il est surtout le fidèle compagnon de Tintin, d'abord par la parole, ensuite par la pensée et par le coeur. Tchang ensuite, qui devient un ami pour la vie, presque un frère. Le capitaine Haddock ensuite, qui est prêt à donner sa vie pour son jeune ami. Et tous les autres, la Castafiore, le professeur Tournesol, Dupond et Dupont, Nestor, etc... En d'autres mots : la famille Tintin !</p></Waypoint>
  <Waypoint>
    ## Profession
